...
rem ESTE SETAT AICI CA SA NU SE SUPRAPUNA CU JAVA_HOME DE LA ASYCUDA
rem set JAVA_HOME=F:\Java\jdk1.5.0_12
...
set JAVA_OPTS=%JAVA_OPTS% -Xms768m -Xmx1024m -XX:+UseParallelGC -XX:+AggressiveHeap -XX:PermSize=128m -XX:MaxPermSize=128m
...
set JAVA_OPTS=-Xdebug -Xrunjdwp:transport=dt_socket,address=8787,suspend=n,server=y %JAVA_OPTS% 
