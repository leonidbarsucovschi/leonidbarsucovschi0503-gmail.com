...
import java.util.*;
import ro.uti.siiv.reports.ReportParameter;

public final class show_005fcontraposition_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/WEB-INF/tld/jportal/pagination.tld");
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_pagination_pager_requestURI_pagesize_method_list_bundle_nobody;
  ...
  public void _jspInit() {
    ...
    _jspx_tagPool_pagination_pager_requestURI_pagesize_method_list_bundle_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    ...
    _jspx_tagPool_pagination_pager_requestURI_pagesize_method_list_bundle_nobody.release();
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script>\r\n");
      out.write("\r\n");
      out.write("function printContraposition()\r\n");
      out.write("{\r\n");
      out.write("\tdocument.getElementById(\"print\").value = \"true\";\r\n");
      out.write("\tdocument.form_ContrapositionForm.submit();\r\n");
      out.write("\tdocument.getElementById(\"print\").value = \"false\";\r\n");
      out.write("}\r\n");
      out.write("\r\n");
...

	{
      ...
      out.write("\t\t\t<img border=\"0\" style=\"cursor:pointer;\" onClick=\"printContraposition();\"\r\n");
      out.write("\t\t\t\t title='");
      if (_jspx_meth_bean_message_19(_jspx_page_context))
        return;
      out.write("' src=\"images/print_ro.gif\"/>\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t</tr>\r\n");
      out.write("</table>\r\n");
      out.write("<br>\r\n");
      ...
      _jspx_th_html_form_0.setAction("/contraposition.do");
	...
	for (int j = 0; j < jrParameters.length; j++)
	{
				...
				&& (visible == null || !visible.equalsIgnoreCase("false")))
		{
          ...
          out.write('"');
          out.write(' ');
          out.print((formParameter != null && formParameter.getEnabled()?"CHECKED":""));
          out.write('>');
          ...
          out.write('"');
          out.write(' ');
          out.print((formParameter != null && SIIVConstants.OPERATOR_EQUAL_STR.equals(formParameter.getOperator())?"SELECTED":""));
          out.write(">\r\n");
          out.write("                \t\t");
          ...
          out.write('"');
          out.write(' ');
          out.print((formParameter != null && SIIVConstants.OPERATOR_GREATER_STR.equals(formParameter.getOperator())?"SELECTED":""));
          out.write(">\r\n");
          out.write("                \t\t");
          ...
          out.write('"');
          out.write(' ');
          out.print((formParameter != null && SIIVConstants.OPERATOR_LESS_STR.equals(formParameter.getOperator())?"SELECTED":""));
          out.write(">\r\n");
          out.write("                \t\t");
          ...
          out.write('"');
          out.write(' ');
          out.print((formParameter != null && SIIVConstants.OPERATOR_GREATER_OR_EQUAL_STR.equals(formParameter.getOperator())?"SELECTED":""));
          out.write(">\r\n");
          out.write("                \t\t");
          ...
          out.write('"');
          out.write(' ');
          out.print((formParameter != null && SIIVConstants.OPERATOR_LESS_OR_EQUAL_STR.equals(formParameter.getOperator())?"SELECTED":""));
          out.write(">\r\n");
          out.write("                \t\t");
          ...
          out.write('"');
          out.write(' ');
          out.print((formParameter != null && SIIVConstants.OPERATOR_BETWEEN_STR.equals(formParameter.getOperator())?"SELECTED":""));
          out.write(">\r\n");
          out.write("                \t\t");
...
if (tooltip != null){
          ...
          out.write('"');
          out.write(' ');
          out.print((formParameter != null && SIIVConstants.OPERATOR_BEGIN_WITH_STR.equals(formParameter.getOperator())?"SELECTED":""));
          out.write(">\r\n");
          out.write("\t\t\t\t\t\t");
          ...
          out.write('"');
          out.write(' ');
          out.print((formParameter != null && SIIVConstants.OPERATOR_END_WITH_STR.equals(formParameter.getOperator())?"SELECTED":""));
          out.write(">\r\n");
          out.write("\t\t\t\t\t\t");
          ...
          out.write('"');
          out.write(' ');
          out.print((formParameter != null && SIIVConstants.OPERATOR_CONTAINS_STR.equals(formParameter.getOperator())?"SELECTED":""));
          out.write(">\r\n");
          out.write("\t\t\t\t\t\t");
...
if (tooltip != null){
          ...
          out.print((formParameter != null && "hs2".equals(value1)?"SELECTED":""));
          out.write(">\r\n");
          out.write("\t\t\t\t\t\t\tNomenclator 2 cifre\r\n");
          out.write("\t\t\t\t\t\t</option>\r\n");
          out.write("\t\t\t\t\t\t<option value=\"hs4\" ");
          out.print((formParameter != null && "hs4".equals(value1)?"SELECTED":""));
          out.write(">\r\n");
          out.write("\t\t\t\t\t\t\tNomenclator 4 cifre\r\n");
          out.write("\t\t\t\t\t\t</option>\r\n");
          out.write("\t\t\t\t\t\t<option value=\"hs6\" ");
          out.print((formParameter != null && "hs6".equals(value1)?"SELECTED":""));
          out.write(">\r\n");
          out.write("\t\t\t\t\t\t\tNomenclator 6 cifre\r\n");
          out.write("\t\t\t\t\t\t</option>\r\n");
          out.write("\t\t\t\t\t\t<option value=\"hs8\" ");
          out.print((formParameter != null && "hs8".equals(value1)?"SELECTED":""));
          out.write(">\r\n");
          ...
          out.write("\t\t\t\t\t");
          //  selection:selectionComponent
          ro.uti.waf.components.selectionComponent.taglib.selectionComponent.SelectionComponentTag _jspx_th_selection_selectionComponent_1 = (ro.uti.waf.components.selectionComponent.taglib.selectionComponent.SelectionComponentTag) _jspx_tagPool_selection_selectionComponent_name_multiple_idTableName_detailsFieldName.get(ro.uti.waf.components.selectionComponent.taglib.selectionComponent.SelectionComponentTag.class);
          _jspx_th_selection_selectionComponent_1.setPageContext(_jspx_page_context);
          _jspx_th_selection_selectionComponent_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_html_form_0);
          _jspx_th_selection_selectionComponent_1.setName("selComp"+i);
          _jspx_th_selection_selectionComponent_1.setDetailsFieldName("dsc");
          _jspx_th_selection_selectionComponent_1.setIdTableName("uncpptab.cpp_cod");
          _jspx_th_selection_selectionComponent_1.setMultiple("false");
          int _jspx_eval_selection_selectionComponent_1 = _jspx_th_selection_selectionComponent_1.doStartTag();
          if (_jspx_eval_selection_selectionComponent_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspx_eval_selection_selectionComponent_1 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
              out = _jspx_page_context.pushBody();
              _jspx_th_selection_selectionComponent_1.setBodyContent((javax.servlet.jsp.tagext.BodyContent) out);
              _jspx_th_selection_selectionComponent_1.doInitBody();
            }
            do {
              out.write("\r\n");
              out.write("\t\t\t\t\t\t");
              if (_jspx_meth_selection_genericSelection_1(_jspx_th_selection_selectionComponent_1, _jspx_page_context))
                return;
              out.write("\r\n");
              out.write("\t\t\t\t\t");
              int evalDoAfterBody = _jspx_th_selection_selectionComponent_1.doAfterBody();
              if (evalDoAfterBody != javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN)
                break;
            } while (true);
            if (_jspx_eval_selection_selectionComponent_1 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
          ...
          if (_jspx_th_selection_selectionComponent_1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            _jspx_tagPool_selection_selectionComponent_name_multiple_idTableName_detailsFieldName.reuse(_jspx_th_selection_selectionComponent_1);
            return;
          }
          _jspx_tagPool_selection_selectionComponent_name_multiple_idTableName_detailsFieldName.reuse(_jspx_th_selection_selectionComponent_1);
          out.write("\r\n");
          ...
          out.write("].value1\" id=\"");
          out.print( "parametersValue1_" + i);
          out.write("\" style=\"visibility:hidden;width:1;height:1\"></select>\r\n");
          out.write("\t\t\t\t\t<script>\r\n");
          out.write("\t\t\t\t\t\t");
          ...
          out.write("\t\t\t\t\t");
          //  selection:selectionComponent
          ro.uti.waf.components.selectionComponent.taglib.selectionComponent.SelectionComponentTag _jspx_th_selection_selectionComponent_2 = (ro.uti.waf.components.selectionComponent.taglib.selectionComponent.SelectionComponentTag) _jspx_tagPool_selection_selectionComponent_name_multiple_idTableName_detailsFieldName.get(ro.uti.waf.components.selectionComponent.taglib.selectionComponent.SelectionComponentTag.class);
          _jspx_th_selection_selectionComponent_2.setPageContext(_jspx_page_context);
          _jspx_th_selection_selectionComponent_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_html_form_0);
          _jspx_th_selection_selectionComponent_2.setName("selComp"+i);
          _jspx_th_selection_selectionComponent_2.setDetailsFieldName("dsc");
          _jspx_th_selection_selectionComponent_2.setIdTableName("uncpptab.cpp_cod");
          _jspx_th_selection_selectionComponent_2.setMultiple("false");
          int _jspx_eval_selection_selectionComponent_2 = _jspx_th_selection_selectionComponent_2.doStartTag();
          if (_jspx_eval_selection_selectionComponent_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspx_eval_selection_selectionComponent_2 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
              out = _jspx_page_context.pushBody();
              _jspx_th_selection_selectionComponent_2.setBodyContent((javax.servlet.jsp.tagext.BodyContent) out);
              _jspx_th_selection_selectionComponent_2.doInitBody();
            }
            do {
              out.write("\r\n");
              out.write("\t\t\t\t\t\t");
              if (_jspx_meth_selection_genericSelection_2(_jspx_th_selection_selectionComponent_2, _jspx_page_context))
                return;
              out.write("\r\n");
              out.write("\t\t\t\t\t");
              int evalDoAfterBody = _jspx_th_selection_selectionComponent_2.doAfterBody();
              if (evalDoAfterBody != javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN)
                break;
            } while (true);
            if (_jspx_eval_selection_selectionComponent_2 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
          ...
          if (_jspx_th_selection_selectionComponent_2.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            _jspx_tagPool_selection_selectionComponent_name_multiple_idTableName_detailsFieldName.reuse(_jspx_th_selection_selectionComponent_2);
            return;
          }
          _jspx_tagPool_selection_selectionComponent_name_multiple_idTableName_detailsFieldName.reuse(_jspx_th_selection_selectionComponent_2);
          out.write("\r\n");
          ...
          out.write("\t\t\t\t\t");
          //  selection:selectionComponent
          ro.uti.waf.components.selectionComponent.taglib.selectionComponent.SelectionComponentTag _jspx_th_selection_selectionComponent_3 = (ro.uti.waf.components.selectionComponent.taglib.selectionComponent.SelectionComponentTag) _jspx_tagPool_selection_selectionComponent_name_multiple_idTableName_detailsFieldName.get(ro.uti.waf.components.selectionComponent.taglib.selectionComponent.SelectionComponentTag.class);
          _jspx_th_selection_selectionComponent_3.setPageContext(_jspx_page_context);
          _jspx_th_selection_selectionComponent_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_html_form_0);
          _jspx_th_selection_selectionComponent_3.setName("selComp"+i);
          _jspx_th_selection_selectionComponent_3.setDetailsFieldName("dsc");
          _jspx_th_selection_selectionComponent_3.setIdTableName("uncp3tab.cp3_cod");
          _jspx_th_selection_selectionComponent_3.setMultiple("false");
          int _jspx_eval_selection_selectionComponent_3 = _jspx_th_selection_selectionComponent_3.doStartTag();
          if (_jspx_eval_selection_selectionComponent_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspx_eval_selection_selectionComponent_3 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
              out = _jspx_page_context.pushBody();
              _jspx_th_selection_selectionComponent_3.setBodyContent((javax.servlet.jsp.tagext.BodyContent) out);
              _jspx_th_selection_selectionComponent_3.doInitBody();
            }
            do {
              out.write("\r\n");
              out.write("\t\t\t\t\t\t");
              if (_jspx_meth_selection_genericSelection_3(_jspx_th_selection_selectionComponent_3, _jspx_page_context))
                return;
              out.write("\r\n");
              out.write("\t\t\t\t\t");
              int evalDoAfterBody = _jspx_th_selection_selectionComponent_3.doAfterBody();
              if (evalDoAfterBody != javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN)
                break;
            } while (true);
            if (_jspx_eval_selection_selectionComponent_3 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
          ...
          if (_jspx_th_selection_selectionComponent_3.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            _jspx_tagPool_selection_selectionComponent_name_multiple_idTableName_detailsFieldName.reuse(_jspx_th_selection_selectionComponent_3);
            return;
          }
          _jspx_tagPool_selection_selectionComponent_name_multiple_idTableName_detailsFieldName.reuse(_jspx_th_selection_selectionComponent_3);
          out.write("\r\n");
          ...
          out.write("\t\t\t\t\t");
          //  selection:selectionComponent
          ro.uti.waf.components.selectionComponent.taglib.selectionComponent.SelectionComponentTag _jspx_th_selection_selectionComponent_4 = (ro.uti.waf.components.selectionComponent.taglib.selectionComponent.SelectionComponentTag) _jspx_tagPool_selection_selectionComponent_name_multiple_idTableName_detailsFieldName.get(ro.uti.waf.components.selectionComponent.taglib.selectionComponent.SelectionComponentTag.class);
          _jspx_th_selection_selectionComponent_4.setPageContext(_jspx_page_context);
          _jspx_th_selection_selectionComponent_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_html_form_0);
          _jspx_th_selection_selectionComponent_4.setName("selComp"+i);
          _jspx_th_selection_selectionComponent_4.setDetailsFieldName("dsc");
          _jspx_th_selection_selectionComponent_4.setIdTableName("uncuotab.cuo_cod");
          _jspx_th_selection_selectionComponent_4.setMultiple("false");
          int _jspx_eval_selection_selectionComponent_4 = _jspx_th_selection_selectionComponent_4.doStartTag();
          if (_jspx_eval_selection_selectionComponent_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspx_eval_selection_selectionComponent_4 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
              out = _jspx_page_context.pushBody();
              _jspx_th_selection_selectionComponent_4.setBodyContent((javax.servlet.jsp.tagext.BodyContent) out);
              _jspx_th_selection_selectionComponent_4.doInitBody();
            }
            do {
              out.write("\r\n");
              out.write("\t\t\t\t\t\t");
              if (_jspx_meth_selection_genericSelection_4(_jspx_th_selection_selectionComponent_4, _jspx_page_context))
                return;
              out.write("\r\n");
              out.write("\t\t\t\t\t");
              int evalDoAfterBody = _jspx_th_selection_selectionComponent_4.doAfterBody();
              if (evalDoAfterBody != javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN)
                break;
            } while (true);
            if (_jspx_eval_selection_selectionComponent_4 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
          ...
          if (_jspx_th_selection_selectionComponent_4.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            _jspx_tagPool_selection_selectionComponent_name_multiple_idTableName_detailsFieldName.reuse(_jspx_th_selection_selectionComponent_4);
            return;
          }
          _jspx_tagPool_selection_selectionComponent_name_multiple_idTableName_detailsFieldName.reuse(_jspx_th_selection_selectionComponent_4);
          out.write("\r\n");
          ...
          out.write("\t\t\t\t\t");
          //  selection:selectionComponent
          ro.uti.waf.components.selectionComponent.taglib.selectionComponent.SelectionComponentTag _jspx_th_selection_selectionComponent_5 = (ro.uti.waf.components.selectionComponent.taglib.selectionComponent.SelectionComponentTag) _jspx_tagPool_selection_selectionComponent_name_multiple_idTableName_detailsFieldName.get(ro.uti.waf.components.selectionComponent.taglib.selectionComponent.SelectionComponentTag.class);
          _jspx_th_selection_selectionComponent_5.setPageContext(_jspx_page_context);
          _jspx_th_selection_selectionComponent_5.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_html_form_0);
          _jspx_th_selection_selectionComponent_5.setName("selComp"+i);
          _jspx_th_selection_selectionComponent_5.setDetailsFieldName("dsc");
          _jspx_th_selection_selectionComponent_5.setIdTableName("nom_country.country_alpha_2");
          _jspx_th_selection_selectionComponent_5.setMultiple("false");
          int _jspx_eval_selection_selectionComponent_5 = _jspx_th_selection_selectionComponent_5.doStartTag();
          if (_jspx_eval_selection_selectionComponent_5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            if (_jspx_eval_selection_selectionComponent_5 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
              out = _jspx_page_context.pushBody();
              _jspx_th_selection_selectionComponent_5.setBodyContent((javax.servlet.jsp.tagext.BodyContent) out);
              _jspx_th_selection_selectionComponent_5.doInitBody();
            }
            do {
              out.write("\r\n");
              out.write("\t\t\t\t\t\t");
              if (_jspx_meth_selection_genericSelection_5(_jspx_th_selection_selectionComponent_5, _jspx_page_context))
                return;
              out.write("\r\n");
              out.write("\t\t\t\t\t");
              int evalDoAfterBody = _jspx_th_selection_selectionComponent_5.doAfterBody();
              if (evalDoAfterBody != javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN)
                break;
            } while (true);
            if (_jspx_eval_selection_selectionComponent_5 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
          ...
          if (_jspx_th_selection_selectionComponent_5.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
            _jspx_tagPool_selection_selectionComponent_name_multiple_idTableName_detailsFieldName.reuse(_jspx_th_selection_selectionComponent_5);
            return;
          }
          _jspx_tagPool_selection_selectionComponent_name_multiple_idTableName_detailsFieldName.reuse(_jspx_th_selection_selectionComponent_5);
          out.write("\r\n");
          ...
          out.write('"');
          out.write(' ');
          out.print((order1 != null && columns[w].equals(order1)?"SELECTED":""));
          out.write(">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t");
          ...
          out.write('"');
          out.write(' ');
          out.print((order2 != null && SIIVConstants.SORT_ORDER_ASCENDING_STR.equals(order2)?"SELECTED":""));
          out.write(">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t");
          ...
          out.write('"');
          out.write(' ');
          out.print((order2 != null && SIIVConstants.SORT_ORDER_DESCENDING_STR.equals(order2)?"SELECTED":""));
          out.write(">\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t");
          ...
          _jspx_th_logic_notEmpty_0.setName("http_report_content");
          ...
          if (_jspx_eval_logic_notEmpty_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              out.write('	');
              //  pagination:pager
              ro.uti.waf.taglib.pagination.PaginationTag _jspx_th_pagination_pager_0 = (ro.uti.waf.taglib.pagination.PaginationTag) _jspx_tagPool_pagination_pager_requestURI_pagesize_method_list_bundle_nobody.get(ro.uti.waf.taglib.pagination.PaginationTag.class);
              _jspx_th_pagination_pager_0.setPageContext(_jspx_page_context);
              _jspx_th_pagination_pager_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_logic_notEmpty_0);
              _jspx_th_pagination_pager_0.setList(SIIVConstants.TBL_CONTRAPOSITION_KEY_FORM);
              _jspx_th_pagination_pager_0.setBundle("app");
              _jspx_th_pagination_pager_0.setPagesize(50);
              _jspx_th_pagination_pager_0.setMethod("showContraposition");
              _jspx_th_pagination_pager_0.setRequestURI("contrapositions/contraposition.do");
              int _jspx_eval_pagination_pager_0 = _jspx_th_pagination_pager_0.doStartTag();
              if (_jspx_th_pagination_pager_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
                _jspx_tagPool_pagination_pager_requestURI_pagesize_method_list_bundle_nobody.reuse(_jspx_th_pagination_pager_0);
                return;
              }
              _jspx_tagPool_pagination_pager_requestURI_pagesize_method_list_bundle_nobody.reuse(_jspx_th_pagination_pager_0);
              out.write("\r\n");
  ...
  private boolean _jspx_meth_bean_message_19(PageContext _jspx_page_context)
    ...
    _jspx_th_bean_message_19.setKey("report.label.print");
  ...
  private boolean _jspx_meth_html_hidden_0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_0.setProperty("report_id");
  ...
  private boolean _jspx_meth_bean_message_59(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_bean_message_59.setKey("report.parameters.operators.numberOrDate.equal");
  ...
  private boolean _jspx_meth_selection_genericSelection_1(javax.servlet.jsp.tagext.JspTag _jspx_th_selection_selectionComponent_1, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  selection:genericSelection
    ro.uti.waf.components.selectionComponent.taglib.selectionComponent.genericSelection.GenericSelectionTag _jspx_th_selection_genericSelection_1 = (ro.uti.waf.components.selectionComponent.taglib.selectionComponent.genericSelection.GenericSelectionTag) _jspx_tagPool_selection_genericSelection_styleClass_showCodeInsert_searchCaseId_knownFieldName.get(ro.uti.waf.components.selectionComponent.taglib.selectionComponent.genericSelection.GenericSelectionTag.class);
    _jspx_th_selection_genericSelection_1.setPageContext(_jspx_page_context);
    _jspx_th_selection_genericSelection_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_selection_selectionComponent_1);
    _jspx_th_selection_genericSelection_1.setSearchCaseId("uncpptabA");
    _jspx_th_selection_genericSelection_1.setShowCodeInsert("true");
    _jspx_th_selection_genericSelection_1.setKnownFieldName("cod");
    _jspx_th_selection_genericSelection_1.setStyleClass("field_input_small");
    int _jspx_eval_selection_genericSelection_1 = _jspx_th_selection_genericSelection_1.doStartTag();
    if (_jspx_eval_selection_genericSelection_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      if (_jspx_eval_selection_genericSelection_1 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
        out = _jspx_page_context.pushBody();
        _jspx_th_selection_genericSelection_1.setBodyContent((javax.servlet.jsp.tagext.BodyContent) out);
        _jspx_th_selection_genericSelection_1.doInitBody();
      }
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t");
        int evalDoAfterBody = _jspx_th_selection_genericSelection_1.doAfterBody();
        if (evalDoAfterBody != javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN)
          break;
      } while (true);
      if (_jspx_eval_selection_genericSelection_1 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
    ...
    if (_jspx_th_selection_genericSelection_1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _jspx_tagPool_selection_genericSelection_styleClass_showCodeInsert_searchCaseId_knownFieldName.reuse(_jspx_th_selection_genericSelection_1);
      return true;
    }
    _jspx_tagPool_selection_genericSelection_styleClass_showCodeInsert_searchCaseId_knownFieldName.reuse(_jspx_th_selection_genericSelection_1);
    return false;
  ...
  private boolean _jspx_meth_selection_genericSelection_2(javax.servlet.jsp.tagext.JspTag _jspx_th_selection_selectionComponent_2, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  selection:genericSelection
    ro.uti.waf.components.selectionComponent.taglib.selectionComponent.genericSelection.GenericSelectionTag _jspx_th_selection_genericSelection_2 = (ro.uti.waf.components.selectionComponent.taglib.selectionComponent.genericSelection.GenericSelectionTag) _jspx_tagPool_selection_genericSelection_styleClass_showCodeInsert_searchCaseId_knownFieldName.get(ro.uti.waf.components.selectionComponent.taglib.selectionComponent.genericSelection.GenericSelectionTag.class);
    _jspx_th_selection_genericSelection_2.setPageContext(_jspx_page_context);
    _jspx_th_selection_genericSelection_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_selection_selectionComponent_2);
    _jspx_th_selection_genericSelection_2.setSearchCaseId("uncpptabB");
    _jspx_th_selection_genericSelection_2.setShowCodeInsert("true");
    _jspx_th_selection_genericSelection_2.setKnownFieldName("cod");
    _jspx_th_selection_genericSelection_2.setStyleClass("field_input_small");
    int _jspx_eval_selection_genericSelection_2 = _jspx_th_selection_genericSelection_2.doStartTag();
    if (_jspx_eval_selection_genericSelection_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      if (_jspx_eval_selection_genericSelection_2 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
        out = _jspx_page_context.pushBody();
        _jspx_th_selection_genericSelection_2.setBodyContent((javax.servlet.jsp.tagext.BodyContent) out);
        _jspx_th_selection_genericSelection_2.doInitBody();
      }
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t");
        int evalDoAfterBody = _jspx_th_selection_genericSelection_2.doAfterBody();
        if (evalDoAfterBody != javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN)
          break;
      } while (true);
      if (_jspx_eval_selection_genericSelection_2 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
    ...
    if (_jspx_th_selection_genericSelection_2.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _jspx_tagPool_selection_genericSelection_styleClass_showCodeInsert_searchCaseId_knownFieldName.reuse(_jspx_th_selection_genericSelection_2);
      return true;
    }
    _jspx_tagPool_selection_genericSelection_styleClass_showCodeInsert_searchCaseId_knownFieldName.reuse(_jspx_th_selection_genericSelection_2);
    return false;
  ...
  private boolean _jspx_meth_bean_message_61(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_bean_message_61.setKey("report.parameters.operators.numberOrDate.equal");
  ...
  private boolean _jspx_meth_selection_genericSelection_3(javax.servlet.jsp.tagext.JspTag _jspx_th_selection_selectionComponent_3, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  selection:genericSelection
    ro.uti.waf.components.selectionComponent.taglib.selectionComponent.genericSelection.GenericSelectionTag _jspx_th_selection_genericSelection_3 = (ro.uti.waf.components.selectionComponent.taglib.selectionComponent.genericSelection.GenericSelectionTag) _jspx_tagPool_selection_genericSelection_styleClass_showCodeInsert_searchCaseId_knownFieldName.get(ro.uti.waf.components.selectionComponent.taglib.selectionComponent.genericSelection.GenericSelectionTag.class);
    _jspx_th_selection_genericSelection_3.setPageContext(_jspx_page_context);
    _jspx_th_selection_genericSelection_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_selection_selectionComponent_3);
    _jspx_th_selection_genericSelection_3.setSearchCaseId("uncp3tab");
    _jspx_th_selection_genericSelection_3.setShowCodeInsert("true");
    _jspx_th_selection_genericSelection_3.setKnownFieldName("cod");
    _jspx_th_selection_genericSelection_3.setStyleClass("field_input_small");
    int _jspx_eval_selection_genericSelection_3 = _jspx_th_selection_genericSelection_3.doStartTag();
    if (_jspx_eval_selection_genericSelection_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      if (_jspx_eval_selection_genericSelection_3 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
        out = _jspx_page_context.pushBody();
        _jspx_th_selection_genericSelection_3.setBodyContent((javax.servlet.jsp.tagext.BodyContent) out);
        _jspx_th_selection_genericSelection_3.doInitBody();
      }
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t");
        int evalDoAfterBody = _jspx_th_selection_genericSelection_3.doAfterBody();
        if (evalDoAfterBody != javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN)
          break;
      } while (true);
      if (_jspx_eval_selection_genericSelection_3 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
    ...
    if (_jspx_th_selection_genericSelection_3.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _jspx_tagPool_selection_genericSelection_styleClass_showCodeInsert_searchCaseId_knownFieldName.reuse(_jspx_th_selection_genericSelection_3);
      return true;
    }
    _jspx_tagPool_selection_genericSelection_styleClass_showCodeInsert_searchCaseId_knownFieldName.reuse(_jspx_th_selection_genericSelection_3);
    return false;
  ...
  private boolean _jspx_meth_bean_message_62(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_bean_message_62.setKey("report.parameters.operators.numberOrDate.equal");
  ...
  private boolean _jspx_meth_selection_genericSelection_4(javax.servlet.jsp.tagext.JspTag _jspx_th_selection_selectionComponent_4, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  selection:genericSelection
    ro.uti.waf.components.selectionComponent.taglib.selectionComponent.genericSelection.GenericSelectionTag _jspx_th_selection_genericSelection_4 = (ro.uti.waf.components.selectionComponent.taglib.selectionComponent.genericSelection.GenericSelectionTag) _jspx_tagPool_selection_genericSelection_styleClass_showCodeInsert_searchCaseId_knownFieldName.get(ro.uti.waf.components.selectionComponent.taglib.selectionComponent.genericSelection.GenericSelectionTag.class);
    _jspx_th_selection_genericSelection_4.setPageContext(_jspx_page_context);
    _jspx_th_selection_genericSelection_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_selection_selectionComponent_4);
    _jspx_th_selection_genericSelection_4.setSearchCaseId("uncuotab");
    _jspx_th_selection_genericSelection_4.setShowCodeInsert("true");
    _jspx_th_selection_genericSelection_4.setKnownFieldName("cod");
    _jspx_th_selection_genericSelection_4.setStyleClass("field_input_small");
    int _jspx_eval_selection_genericSelection_4 = _jspx_th_selection_genericSelection_4.doStartTag();
    if (_jspx_eval_selection_genericSelection_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      if (_jspx_eval_selection_genericSelection_4 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
        out = _jspx_page_context.pushBody();
        _jspx_th_selection_genericSelection_4.setBodyContent((javax.servlet.jsp.tagext.BodyContent) out);
        _jspx_th_selection_genericSelection_4.doInitBody();
      }
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t");
        int evalDoAfterBody = _jspx_th_selection_genericSelection_4.doAfterBody();
        if (evalDoAfterBody != javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN)
          break;
      } while (true);
      if (_jspx_eval_selection_genericSelection_4 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
    ...
    if (_jspx_th_selection_genericSelection_4.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _jspx_tagPool_selection_genericSelection_styleClass_showCodeInsert_searchCaseId_knownFieldName.reuse(_jspx_th_selection_genericSelection_4);
      return true;
    }
    _jspx_tagPool_selection_genericSelection_styleClass_showCodeInsert_searchCaseId_knownFieldName.reuse(_jspx_th_selection_genericSelection_4);
    return false;
  ...
  private boolean _jspx_meth_bean_message_63(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_bean_message_63.setKey("report.parameters.operators.numberOrDate.equal");
  ...
  private boolean _jspx_meth_selection_genericSelection_5(javax.servlet.jsp.tagext.JspTag _jspx_th_selection_selectionComponent_5, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  selection:genericSelection
    ro.uti.waf.components.selectionComponent.taglib.selectionComponent.genericSelection.GenericSelectionTag _jspx_th_selection_genericSelection_5 = (ro.uti.waf.components.selectionComponent.taglib.selectionComponent.genericSelection.GenericSelectionTag) _jspx_tagPool_selection_genericSelection_styleClass_showCodeInsert_searchCaseId_knownFieldName.get(ro.uti.waf.components.selectionComponent.taglib.selectionComponent.genericSelection.GenericSelectionTag.class);
    _jspx_th_selection_genericSelection_5.setPageContext(_jspx_page_context);
    _jspx_th_selection_genericSelection_5.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_selection_selectionComponent_5);
    _jspx_th_selection_genericSelection_5.setSearchCaseId("nom_countryA2");
    _jspx_th_selection_genericSelection_5.setShowCodeInsert("true");
    _jspx_th_selection_genericSelection_5.setKnownFieldName("cod");
    _jspx_th_selection_genericSelection_5.setStyleClass("field_input_small");
    int _jspx_eval_selection_genericSelection_5 = _jspx_th_selection_genericSelection_5.doStartTag();
    if (_jspx_eval_selection_genericSelection_5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      if (_jspx_eval_selection_genericSelection_5 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
        out = _jspx_page_context.pushBody();
        _jspx_th_selection_genericSelection_5.setBodyContent((javax.servlet.jsp.tagext.BodyContent) out);
        _jspx_th_selection_genericSelection_5.doInitBody();
      }
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t");
        int evalDoAfterBody = _jspx_th_selection_genericSelection_5.doAfterBody();
        if (evalDoAfterBody != javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN)
          break;
      } while (true);
      if (_jspx_eval_selection_genericSelection_5 != javax.servlet.jsp.tagext.Tag.EVAL_BODY_INCLUDE) {
    ...
    if (_jspx_th_selection_genericSelection_5.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _jspx_tagPool_selection_genericSelection_styleClass_showCodeInsert_searchCaseId_knownFieldName.reuse(_jspx_th_selection_genericSelection_5);
      return true;
    }
    _jspx_tagPool_selection_genericSelection_styleClass_showCodeInsert_searchCaseId_knownFieldName.reuse(_jspx_th_selection_genericSelection_5);
    return false;
  ...
  private boolean _jspx_meth_bean_message_64(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_bean_message_64.setBundle("report");
    _jspx_th_bean_message_64.setKey("report.parameters.label.order");
  ...
  private boolean _jspx_meth_bean_message_65(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_bean_message_65.setBundle("report");
    _jspx_th_bean_message_65.setKey("report.parameters.operators.numberOrDate.equal");
  ...
  private boolean _jspx_meth_bean_message_66(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_bean_message_66.setBundle("report");
    _jspx_th_bean_message_66.setKey("report.parameters.operators.text.Asc");
  ...
  private boolean _jspx_meth_bean_message_67(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_bean_message_67.setBundle("report");
    _jspx_th_bean_message_67.setKey("report.parameters.operators.text.Desc");
  ...
  private boolean _jspx_meth_html_submit_0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_html_submit_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\r\n");
        out.write("            ");
        if (_jspx_meth_bean_message_68(_jspx_th_html_submit_0, _jspx_page_context))
          return true;
        out.write("\r\n");
        out.write("        ");
  ...
  private boolean _jspx_meth_bean_message_68(javax.servlet.jsp.tagext.JspTag _jspx_th_html_submit_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  bean:message
    ...
    _jspx_th_bean_message_68.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_html_submit_0);
    _jspx_th_bean_message_68.setBundle("report");
    _jspx_th_bean_message_68.setKey("report.button.report");
  ...
  private boolean _jspx_meth_html_hidden_1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_1.setValue("showContraposition");
  ...
  private boolean _jspx_meth_html_hidden_2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_form_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_2.setProperty("print");
  ...
  private boolean _jspx_meth_bean_write_2(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_notEmpty_0, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  bean:write
    org.apache.struts.taglib.bean.WriteTag _jspx_th_bean_write_2 = (org.apache.struts.taglib.bean.WriteTag) _jspx_tagPool_bean_write_name_filter_nobody.get(org.apache.struts.taglib.bean.WriteTag.class);
    _jspx_th_bean_write_2.setPageContext(_jspx_page_context);
    _jspx_th_bean_write_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_logic_notEmpty_0);
    _jspx_th_bean_write_2.setName("http_report_content");
    _jspx_th_bean_write_2.setFilter(false);
    int _jspx_eval_bean_write_2 = _jspx_th_bean_write_2.doStartTag();
    if (_jspx_th_bean_write_2.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _jspx_tagPool_bean_write_name_filter_nobody.reuse(_jspx_th_bean_write_2);
      return true;
    }
    _jspx_tagPool_bean_write_name_filter_nobody.reuse(_jspx_th_bean_write_2);
    return false;
