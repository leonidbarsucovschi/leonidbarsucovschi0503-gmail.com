...
public final class list_005flista_005fadmsessionoperation_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      _jspx_th_display_table_0.setList(Constants.ADM_SESSION_OPERATION_KEY_LIST);
      ...
      _jspx_th_display_table_0.setRequestURI("sys/admsessionoperation.do");
      _jspx_th_display_table_0.setDecorator("ro.uti.siiv.sys.util.SessionOperationTableDecorator");
  ...
  private boolean _jspx_meth_display_column_0(javax.servlet.jsp.tagext.JspTag _jspx_th_display_table_0, PageContext _jspx_page_context)
    ...
    //  display:column
    ro.uti.waf.taglib.table.ColumnTag _jspx_th_display_column_0 = (ro.uti.waf.taglib.table.ColumnTag) _jspx_tagPool_display_column_title_style_sortable_property_decorator_bundle_nobody.get(ro.uti.waf.taglib.table.ColumnTag.class);
    ...
    _jspx_th_display_column_0.setProperty("operation_date");
    _jspx_th_display_column_0.setBundle("admsessionoperation");
    _jspx_th_display_column_0.setTitle("adm_session_operation.prompt.operation_date");
    _jspx_th_display_column_0.setSortable("operation_date");
    _jspx_th_display_column_0.setStyle("sortable");
    _jspx_th_display_column_0.setDecorator("table");
    ...
    if (_jspx_th_display_column_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) {
      _jspx_tagPool_display_column_title_style_sortable_property_decorator_bundle_nobody.reuse(_jspx_th_display_column_0);
      return true;
    }
    _jspx_tagPool_display_column_title_style_sortable_property_decorator_bundle_nobody.reuse(_jspx_th_display_column_0);
    return false;
  ...
  private boolean _jspx_meth_display_column_1(javax.servlet.jsp.tagext.JspTag _jspx_th_display_table_0, PageContext _jspx_page_context)
    ...
    _jspx_th_display_column_1.setProperty("user_login");
    _jspx_th_display_column_1.setBundle("admusersession");
    _jspx_th_display_column_1.setTitle("adm_user_session.prompt.fk_user");
    _jspx_th_display_column_1.setSortable("fk_user");
  ...
  private boolean _jspx_meth_display_column_2(javax.servlet.jsp.tagext.JspTag _jspx_th_display_table_0, PageContext _jspx_page_context)
    ...
    _jspx_th_display_column_2.setProperty("opp_name");
    _jspx_th_display_column_2.setBundle("admoperationtype");
    _jspx_th_display_column_2.setTitle("adm_operation_type.prompt.opp_name");
    _jspx_th_display_column_2.setSortable("opp_name");
  ...
  private boolean _jspx_meth_display_column_3(javax.servlet.jsp.tagext.JspTag _jspx_th_display_table_0, PageContext _jspx_page_context)
    ...
    _jspx_th_display_column_3.setProperty("description");
    _jspx_th_display_column_3.setBundle("admoperationtype");
    _jspx_th_display_column_3.setTitle("adm_operation_type.prompt.description");
    _jspx_th_display_column_3.setSortable("description");
  ...
  private boolean _jspx_meth_display_column_4(javax.servlet.jsp.tagext.JspTag _jspx_th_display_table_0, PageContext _jspx_page_context)
    ...
    _jspx_th_display_column_4.setBundle("admsessionoperation");
    _jspx_th_display_column_4.setWidth("80");
    _jspx_th_display_column_4.setKeyprefix("adm_session_operation");
    _jspx_th_display_column_4.setDecorator("table");
    _jspx_th_display_column_4.setPkName("id_session_operation");
