...
TinyMCE_Engine.prototype = {
	init : function(settings) {
        ...
        this.rootURL = this.documentBasePath.substring(0, this.documentBasePath.lastIndexOf('/'));
	...
	setupContent : function(editor_id) {
		...
		tinyMCE.importCSS(inst.getDoc(),tinyMCE.rootURL + "/css/global_styles.css");
		tinyMCE.importCSS(inst.getDoc(),tinyMCE.rootURL + "/css/page_styles.css");
		tinyMCE.importCSS(inst.getDoc(),tinyMCE.rootURL + "/css/element_styles.css");
		tinyMCE.importCSS(inst.getDoc(),tinyMCE.rootURL + "/css/displaytag.css");
