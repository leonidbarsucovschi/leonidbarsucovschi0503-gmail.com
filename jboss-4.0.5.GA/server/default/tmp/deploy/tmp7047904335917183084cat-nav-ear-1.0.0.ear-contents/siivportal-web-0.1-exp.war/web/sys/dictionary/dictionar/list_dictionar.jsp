...
<html:form action="dictionar.do" styleId="addForm">
...
<div class="table">
  <table width="100%" cellspacing="0" cellpadding="0" border="0">
    <tr class="bottom">
      <td width="71%" class="page-title-header" align="left">
        ...
        <b><bean:message bundle="dictionar" key="dictionar.title.list"/>
      ...
      <td valign="middle" nowrap="true" align="right">
        <a href="javascript:document.getElementById('addForm').submit()">
          <img border="0" src="images/add.gif"  title="<bean:message bundle="dictionar" key="dictionar.button.add"/>" />
        </a>
  ...
  <table width="100%">
    ...
    <tr>
      <td colspan="2">
        <jsp:include page="search_dictionar.jsp" flush="true"/>
      </td>
    </tr>
    <!-- #############################-->
  ...
  <jsp:include page="list_lista_dictionar.jsp" flush="true"/>
</div>
<form name="actionForm" method="post" action="sys/dictionar.do">
  <input type="hidden" name="method" />
  <input type="hidden" name="page" />
  <input type="hidden" name="prefix" value="/" />
  <input type="hidden" name="id_dictionar" />
</form>
