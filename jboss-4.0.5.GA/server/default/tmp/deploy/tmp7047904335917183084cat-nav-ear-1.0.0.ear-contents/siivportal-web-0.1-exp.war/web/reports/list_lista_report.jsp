...
<div>
  <display:table list="<%=Constants.TBL_REPORT_KEY_LIST%>" crt="yes" bundle="app" style="report" pagesize="50" method="list" requestURI="reports/report.do" decorator="ro.uti.apmc.sys.util.ReportTableDecorator">
    <display:column property="name" bundle="report" title="report.prompt.name" sortable="name" style="sortable"/>
    ...
    <display:column property="noPrint" bundle="report" width="80" keyprefix="report" decorator="table" pkName="report_id"/>
  </display:table>
</div>
