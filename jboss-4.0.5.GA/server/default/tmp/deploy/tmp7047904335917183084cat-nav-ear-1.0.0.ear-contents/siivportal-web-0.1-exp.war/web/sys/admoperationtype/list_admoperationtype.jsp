...
<html:form action="admoperationtype.do" styleId="addForm">
...
<div class="table">
  <table width="100%" cellspacing="0" cellpadding="0" border="1">
    <tr class="bottom">
      <td width="71%" class="page-title-header" align="left">
        ...
        <b><bean:message bundle="admoperationtype" key="adm_operation_type.title.list"/>
      ...
      <td valign="middle" nowrap="true" align="right">
        <a href="javascript:document.getElementById('addForm').submit()">
          <img border="0" src="images/add.gif"  title="<bean:message bundle="admoperationtype" key="adm_operation_type.button.add"/>" />
        </a>
  ...
  <table width="100%">
    ...
    <tr>
      <td colspan="2">
        <jsp:include page="search_admoperationtype.jsp" flush="true"/>
      </td>
    </tr>
    <!-- #############################-->
  ...
  <jsp:include page="list_lista_admoperationtype.jsp" flush="true"/>
</div>
<form name="actionForm" method="post" action="sys/admoperationtype.do">
  <input type="hidden" name="method" />
  <input type="hidden" name="page" />
  <input type="hidden" name="prefix" value="/" />
  <input type="hidden" name="id_operation_type" />
</form>
