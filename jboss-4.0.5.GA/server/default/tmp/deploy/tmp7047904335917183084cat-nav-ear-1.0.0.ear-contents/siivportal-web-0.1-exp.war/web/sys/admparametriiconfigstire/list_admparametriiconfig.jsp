...
<div class="table">
  <table width="100%" cellspacing="0" cellpadding="0" border="0">
    <tr class="bottom">
      ...
      <td>
        <html:form action="admparametriiconfigstire.do" styleId="addForm">
      ...
      <td valign="middle" nowrap="true" align="right">
        <a href="javascript:document.getElementById('addForm').submit()">
          <img border="0" src="images/add.gif" width="19" height="19" title="<bean:message bundle="admparametriiconfig" key="adm_parametrii_config.button.add"/>" />
        </a>
        <img src="images/lupa_1.gif" width="19" height="19" onClick="javascript:showLayer('search')" class="arrow" border="0">
        <input type="image" onClick="javascript:refresh();" name="reload_btn" src="images/refresh_1_3.gif" width="19" height="19" border="0" title='<bean:message  bundle="app" key="message.button.tooltip.refresh"/>' />
      </td>
    </tr>
  </table>
  <table width="100%">
...
<form name="actionForm" method="post" action="sys/admparametriiconfigstire.do">
