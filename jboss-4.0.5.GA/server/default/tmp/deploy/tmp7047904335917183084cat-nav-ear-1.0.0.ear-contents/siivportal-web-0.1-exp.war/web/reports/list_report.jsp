...
<html:form action="report.do" styleId="addForm">
...
<div class="table">
    <table width="100%" cellspacing="0" cellpadding="0" border="0">
        <tr class="page-title-header">
            <td width="71%">
                ...
                <bean:message bundle="report" key="report.admin.title.list"/>
            </td>
            <td valign="middle" nowrap="true" align="right">
                <us:checkAccess command="report.do" action="showAdd">
                    <input type="image" src="images/add.gif"
                           ...
                           title='<bean:message bundle="report" key="report.button.add"/>'/>
                </us:checkAccess>
    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="2">
                <jsp:include page="list_lista_report.jsp" flush="true"/>
            </td>
        </tr>
    </table>
</div>
