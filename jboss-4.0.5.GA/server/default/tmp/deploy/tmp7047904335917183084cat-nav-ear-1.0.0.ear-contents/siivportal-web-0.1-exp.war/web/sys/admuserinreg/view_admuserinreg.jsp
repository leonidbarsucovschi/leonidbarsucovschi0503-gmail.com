  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="1">
    <tr >
      <td width="100%" valign="top" align="left" class="page-subtitle">
        <!-- Titlul ferestrei. -->
        <bean:message bundle="admuserinreg" key="adm_user_inreg.title.view"/>
...
<%--  <html:hidden property="method"  value="list"/>--%>
  <html:hidden property="method" value="closeView"/>
  <input type="hidden" name="email_user" value='<bean:write  property="email_user" name="<%=Constants.ADM_USER_INREG_KEY%>"/>'/>
  <input type="hidden" name="fk_limba" value='<bean:write  property="fk_limba_stiri" name="<%=Constants.ADM_USER_INREG_KEY%>"/>'/>
</form>
<script>
