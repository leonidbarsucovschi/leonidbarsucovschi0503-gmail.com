...
<script type="text/javascript">var crntLanguage = <%=JPortalActionContext.getActionContext().getCurrentLanguageId()%></script>  
<script type="text/javascript" src="web/portal/map/js/flashcontent.js"></script>
