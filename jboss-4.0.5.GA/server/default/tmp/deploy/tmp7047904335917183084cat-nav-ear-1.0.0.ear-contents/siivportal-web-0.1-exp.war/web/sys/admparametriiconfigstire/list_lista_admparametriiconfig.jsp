...
<div>
  <display:table list="<%=Constants.ADM_PARAMETRII_CONFIG_KEY_LIST%>" crt="yes" bundle="app" style="report" pagesize="50" method="list" requestURI="sys/admparametriiconfigstire.do" decorator="ro.uti.waf.taglib.table.DefaultTableDecorator">
    ...
    <display:column property="noPrint"   bundle="admparametriiconfig"  width="80" keyprefix="adm_parametrii_config" decorator="default" pkName="id_parametrii_config"/>
  </display:table>
</div>
