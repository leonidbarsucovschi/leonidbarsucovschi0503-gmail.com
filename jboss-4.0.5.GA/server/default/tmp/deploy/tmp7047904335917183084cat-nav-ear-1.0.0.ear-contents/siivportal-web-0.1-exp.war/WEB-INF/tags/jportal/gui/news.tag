...
<%@ tag import="ro.uti.settings.util.Constants" %>
            ...
            <TD bgColor=#ffffff>
                <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
                    <TBODY>
                        ...
                        <tr>
                          <logic:equal value="<%=Constants.POLITICA_UE_NEWS%>" name='type'>
                                <TD>
                          ...
                          <logic:notEqual value="<%=Constants.POLITICA_UE_NEWS%>" name="type">
                            <TD>
                                <A class=homepagelink
