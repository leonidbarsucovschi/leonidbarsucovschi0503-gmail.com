...
var flashPage   = "blank.html"  // The location of the flash movie page
var noFlashPage = "blank.html"  // Page displayed if the user doesn't have the
                                // plugin or we can't detect it.
var upgradePage = "blank.html"  // Page displayed if we detect an old plugin
// =============================================================================
  ...
  if (actualVersion >= requiredVersion) {
    ...
    if (useRedirect) {
      ...
      if(jsVersion > 1.0) {
        ...
        window.location = flashPage;
            ...
            document.write(flashContent);   // embed the flash movie
	}
    ...
    if (useRedirect) {
      ...
      if(jsVersion > 1.0) {
		...
		document.write(upgradeContent);   // embed the flash movie
    }
  }
}
