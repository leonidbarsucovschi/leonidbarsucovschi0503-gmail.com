...
//
// $Id: htmlarea.js,v 1.5 2006/03/13 15:45:46 dan.pavel Exp $
...
HTMLArea.prototype.generate = function () {
	...
	function initIframe() {
		...
		if (!editor.config.fullPage) {
			...
			html += '<link rel="stylesheet" type="text/css" media="screen" href="/siiv/htmlarea/continut_static.css">\n';	
			html += "</head>\n";
			html += "<body>\n";
...
HTMLArea.prototype._wordClean = function() {
	var D = this._clipboardHTML();
	alert(D);
	if (D.indexOf('Mso') >= 0 || D.indexOf('mso') >= 0) {
...
HTMLArea.prototype.execCommand = function(cmdID, UI, param) {
	...
	switch (cmdID) {
	    ...
	    case "cut": this._doc.execCommand(cmdID, UI, param);break;
	    case "copy": this._doc.execCommand(cmdID, UI, param);break;
	    case "paste":
		try {
...
HTMLArea.htmlEncode = function(str) {
	...
	str = str.replace(/\xAE/ig, "&reg;");
	str = str.replace(/\xB0/ig, "&deg;");
	str = str.replace(/\u20AC/ig, "&euro;");
	str = str.replace(/\u2026/ig, "&hellip;");
	str = str.replace(/\xA0/ig, "&nbsp;");
	str = str.replace(/\u2019/ig, "&rsquo;");
...
/**
*scrie intr-un div invizibil ce este in cliboard
*apoi aplica _wordClean la ce este acolo si intoarce "html curat"
*
*/
HTMLArea.prototype._clipboardHTML = function() {
  var div = document.getElementById('_clipboardHTML');
