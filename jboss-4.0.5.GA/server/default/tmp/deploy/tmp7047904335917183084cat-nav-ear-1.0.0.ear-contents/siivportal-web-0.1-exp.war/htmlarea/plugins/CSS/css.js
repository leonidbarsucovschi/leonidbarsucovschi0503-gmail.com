...
//
// $Id: css.js,v 1.2 2006/02/13 13:02:05 dan.pavel Exp $
...
CSS.prototype.updateValue = function(editor, obj) {
    //merg pe parinte in sus pana gasesc o clasa din lista sau nu
	var select = editor._toolbarObjects[obj.id].element;
	var parent = editor.getParentElement();
	var options = select.options;
	while(true) {
	  if (parent.nodeName=="BODY" || parent.nodeName=="BASE" || parent.nodeName=="HEAD" || parent.nodeName=="HTML") {
